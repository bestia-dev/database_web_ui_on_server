...
fn task_build() {
    ...
    //run_shell_command("rsync -a --info=progress2 --delete-after tier1_browser_wasm/pkg/ web_server_folder/database_web_ui_on_server/pkg/");
...
fn task_release() {
    ...
    run_shell_command("strip target/release/database_web_ui_on_server");
...
fn task_publish_to_web() {
    ...
    // rsync files
    //run_shell_command("rsync -e ssh -a --info=progress2 ./target/release/database_web_ui_on_server luciano_bestia@bestia.dev:/var/www/transfer_folder/database_web_ui_on_server/");
    //run_shell_command("rsync -e ssh -a --info=progress2 ./.env luciano_bestia@bestia.dev:/var/www/transfer_folder/database_web_ui_on_server/");
    //run_shell_command("rsync -e ssh -a --info=progress2 ./deploy/buildah_image_database_web_ui_on_server.sh luciano_bestia@bestia.dev:/var/www/transfer_folder/database_web_ui_on_server/");
    //run_shell_command("rsync -e ssh -a --info=progress2 ./deploy/database_web_ui_on_server_pod_create.sh luciano_bestia@bestia.dev:/var/www/transfer_folder/database_web_ui_on_server/");
