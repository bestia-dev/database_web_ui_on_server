// automation_tasks_rs for database_web_ui_on_server workspace
...
fn task_build() {
    ...
    // auto_check_micro_xml("web_server_folder/database_web_ui_on_server");
    cl::auto_version_increment_semver_or_date();
    cl::run_shell_command("cargo fmt");
    //cl::run_shell_command("cd tier1_browser_wasm;wasm-pack build --target web;cd ..");
    // copy to web_server_folder/pkg
    //cl::run_shell_command("rsync -a --info=progress2 --delete-after tier1_browser_wasm/pkg/ web_server_folder/database_web_ui_on_server/pkg/");
...
fn task_release() {
    ...
    cl::run_shell_command("strip target/release/database_web_ui_on_server");
...
fn task_publish_to_web() {
    ...
    // rsync files
    //cl::run_shell_command("rsync -e ssh -a --info=progress2 ./target/release/database_web_ui_on_server luciano_bestia@bestia.dev:/var/www/transfer_folder/database_web_ui_on_server/");
    //cl::run_shell_command("rsync -e ssh -a --info=progress2 ./.env luciano_bestia@bestia.dev:/var/www/transfer_folder/database_web_ui_on_server/");
    //cl::run_shell_command("rsync -e ssh -a --info=progress2 ./deploy/buildah_image_database_web_ui_on_server.sh luciano_bestia@bestia.dev:/var/www/transfer_folder/database_web_ui_on_server/");
    //cl::run_shell_command("rsync -e ssh -a --info=progress2 ./deploy/database_web_ui_on_server_pod_create.sh luciano_bestia@bestia.dev:/var/www/transfer_folder/database_web_ui_on_server/");
...
cd /var/www/transfer_folder/database_web_ui_on_server
sh buildah_image_database_web_ui_on_server.sh
sh database_web_ui_on_server_pod_create.sh
    Test the postgres server:
psql -h localhost -p 5432 -U admin -W
    Test the web application locally:
curl http://localhost:8011/database_web_ui_on_server/get_svg_image/555555.svg
    Test the web application on the internet:
curl https://bestia.dev/database_web_ui_on_server/get_svg_image/555555.svg
{RESET}"#
    );
}
// endregion: tasks
